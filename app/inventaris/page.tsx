    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Mode Akses: <span className="font-bold text-blue-600">{activeUser}</span></p>
        </div>
      ...
      <div className="bg-white p-4 rounded-xl border mb-6 shadow-sm">
        <form method="GET" className="flex gap-4">
          ...
          <button type="submit" className="bg-slate-800 text-white px-6 py-2 rounded-lg font-medium hover:bg-slate-900 transition-colors">Cari</button>
        </form>
      </div>
                  ...
                  <tr key={laptop.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-2 justify-center">
                        <Link href={`/inventaris/edit/${laptop.id}`} className="p-2.5 bg-slate-100 text-slate-600 rounded-lg hover:bg-amber-100 hover:text-amber-700 transition-colors">
                          <Edit size={16} />
                        </Link>
